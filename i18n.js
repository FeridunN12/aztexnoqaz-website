(() => {
  ...
  const rows = {
    ...
    "Choose a product photo smaller than 25 MB.": ["25 MB-dan kiçik məhsul şəkli seçin.", "Choose a product photo smaller than 25 MB.", "25 MB'den küçük bir ürün fotoğrafı seçin.", "Выберите фото товара размером менее 25 МБ.", "აირჩიეთ 25 მბ-ზე მცირე პროდუქტის ფოტო.", "عکس محصولی کوچک‌تر از ۲۵ مگابایت انتخاب کنید."],
    ...
    "Saving product...": ["Məhsul yadda saxlanılır...", "Saving product...", "Ürün kaydediliyor...", "Сохранение товара...", "პროდუქტი ინახება...", "در حال ذخیره محصول..."],
    "Detecting language and translating product text...": ["Dil müəyyən edilir və məhsul mətni tərcümə olunur...", "Detecting language and translating product text...", "Dil algılanıyor ve ürün metni çevriliyor...", "Определение языка и перевод текста товара...", "მიმდინარეობს ენის ამოცნობა და პროდუქტის ტექსტის თარგმნა...", "در حال تشخیص زبان و ترجمه متن محصول..."],
    "Automatic translation is temporarily unavailable. Try publishing again.": ["Avtomatik tərcümə müvəqqəti əlçatan deyil. Yenidən yayımlamağa çalışın.", "Automatic translation is temporarily unavailable. Try publishing again.", "Otomatik çeviri geçici olarak kullanılamıyor. Yeniden yayınlamayı deneyin.", "Автоматический перевод временно недоступен. Попробуйте опубликовать снова.", "ავტომატური თარგმანი დროებით მიუწვდომელია. სცადეთ ხელახლა გამოქვეყნება.", "ترجمه خودکار موقتاً در دسترس نیست. دوباره انتشار را امتحان کنید."],
    "The product upload was interrupted. Check your connection and try again.": ["Məhsulun yüklənməsi kəsildi. İnternet bağlantısını yoxlayın və yenidən cəhd edin.", "The product upload was interrupted. Check your connection and try again.", "Ürün yüklemesi kesildi. Bağlantınızı kontrol edip tekrar deneyin.", "Загрузка товара была прервана. Проверьте подключение и повторите попытку.", "პროდუქტის ატვირთვა შეწყდა. შეამოწმეთ კავშირი და სცადეთ ხელახლა.", "بارگذاری محصول قطع شد. اتصال خود را بررسی کرده و دوباره تلاش کنید."],
